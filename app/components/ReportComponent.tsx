...
const ReportComponent = () => {
  ...
  return (
    <div className="Report-Component my-2 ">
      <div className="bg-white border border-black flex justify-between xxs:w-60 xs:w-64 sm:w-72 rounded-md">
      ...
      <div className="xxs:w-60 xs:w-64 sm:w-72 border border-black bg-white rounded-md">
