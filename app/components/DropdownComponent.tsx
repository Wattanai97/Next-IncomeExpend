...
const DropdownComponent = () => {
    const {setTogglereport,setToggleform,setToggletrans,setToggleeditform} = useGlobalState()
  ...
  return (
    <div className="Trans-Component my-4">
      <Dropdown className="font text-lg" size="lg" label="Open Menu">
        ...
        <Dropdown.Item onClick={()=>{setToggleform((prev:boolean)=>!prev);setToggleeditform(false)}}
